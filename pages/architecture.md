...
A _Provider Handler_ is just a module that defines a function of arity 2 that takes the request to handle and a `%Lexical.Project{}`. These functions can reply to the request, ignore it, or do some other action.

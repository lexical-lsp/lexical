# defmodule Lexical.Protocol.Types do
...
#   defmodule PositionEncodingKind do
#     use Proto
...
#     deftype name: optional(string()),
#             version: optional(string())
#   end

#   defmodule ServerCapabilities do
#     use Proto
#     deftype position_encoding_kind: optional(PositionEncodingKind)
#   end

defmodule Lexical.Server.CodeIntelligence.Completion.Translations.Macro do
  ...
  def translate(%Result.Macro{name: "def", arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defp", arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defmodule"} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defmacro", arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defmacrop", arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defprotocol"} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defimpl", arity: 3} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defoverridable"} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defdelegate", arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defguard", arity: 1} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defguardp", arity: 1} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defexception", arity: 1} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "defstruct", arity: 1} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "alias", arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "require" <> _, arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "quote" <> _, arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "receive" <> _, arity: 1} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "try" <> _, arity: 1} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "with" <> _, arity: 1} = macro, builder, _env) do
    label = "with block"
  ...
  def translate(%Result.Macro{name: "case", arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "if", arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "import", arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "unless", arity: 2} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "cond"} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: "for"} = macro, builder, _env) do
  ...
  def translate(%Result.Macro{name: dunder_form} = macro, builder, _env)

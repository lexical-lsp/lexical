defmodule Lexical.Server.CodeIntelligence.Completion.Translations.Macro do
  ...
  def translate(%Result.Macro{name: "defp", arity: 2} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "defmodule"} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "defmacro", arity: 2} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "defmacrop", arity: 2} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "defprotocol"} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "defimpl", arity: 3} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "defoverridable"} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "defdelegate", arity: 2} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "defguard", arity: 1} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "defguardp", arity: 1} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "defexception", arity: 1} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "defstruct", arity: 1} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "alias", arity: 2} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "require" <> _, arity: 2} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "quote" <> _, arity: 2} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "receive" <> _, arity: 1} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "try" <> _, arity: 1} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "with" <> _, arity: 1} = macro, _env) do
    label = "with block"
  ...
  def translate(%Result.Macro{name: "case", arity: 2} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "if", arity: 2} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "import", arity: 2} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "unless", arity: 2} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "cond"} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "for"} = macro, _env) do
  ...
  def translate(%Result.Macro{name: "__MODULE__"} = macro, env) do
    if Env.struct_reference?(env) do
      plain_text("%__MODULE__{}",
        detail: "%__MODULE__{}",
        label: "%__MODULE__{}",
        kind: :struct
      )
  ...
  def translate(%Result.Macro{name: dunder_form} = macro, _env)
      when dunder_form in ~w(__CALLER__ __DIR__ __ENV__ __MODULE__ __STACKTRACE__) do
    plain_text(dunder_form,
      detail: macro.spec,
      kind: :constant,
      label: dunder_form,
      sort_text: boost(dunder_form)
    )
  end

  def translate(%Result.Macro{name: dunder_form}, _env)
      when dunder_form in ~w(__aliases__ __block__) do
    :skip
  end

  def translate(%Result.Macro{name: name} = macro, _env)
  ...
  def translate(%Result.Macro{}, _env) do
    :skip
  end
end
